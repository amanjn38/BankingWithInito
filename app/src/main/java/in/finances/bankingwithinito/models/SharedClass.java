...
public final class SharedClass {
    ...
    public static final int STATUS_PICKUP = 1004;
    public static final int STATUS_ACCEPTED = 1005;
    ...
    public static final int PICKUP_AND_PAYINCASH = 0;
    public static final int PICKUP_AND_PAYONLINE = 1;
    public static final int HOMEDELIVERY_AND_PAYINCASH = 2;
    public static final int HOMEDELIVERY_AND_PAYONLINE = 3;
